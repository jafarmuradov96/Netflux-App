...
const Movies = ({ movieData, loading, handleMovieClick }) => {
  ...
  if (sortedRating === 'sortedRating') {
    sortedYearsMovies = [...movieData].sort((a, b) => {
      return parseFloat(b.vote_average).toFixed(1) - parseFloat(a.vote_average).toFixed(1)
    })
  }
  ...
  return (
    <div className="container">
        <div className="movies">
          ...
          <div className="">
              <MoviesList sortedYearsMovies = {sortedYearsMovies} handleMovieClick = {handleMovieClick} movieData = {movieData} loading = {loading} />
          </div>
        </div>
    </div>
  )
